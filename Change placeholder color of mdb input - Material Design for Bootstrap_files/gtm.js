...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_ignoreCase":true,
      "vtp_map":["list",["map","key","^#$","value",["macro",74]]]
    },{
      "function":"__u",
      "vtp_component":"HOST",
      "vtp_enableMultiQueryKeys":false,
  ...
  "tags":[{
      ...
      "vtp_eventCategory":["template","First conversions ",["macro",66]],
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",14],
  ...
  "rules":[
    [["if",0],["add",0,3,55,67,134,142,71,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,89,90,91,92,93,94,95,96,97,98,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,118,119,120,121,122,123,124,126,127,128,129,130,131,132,133]],
    [["if",1,2],["add",1]],
    [["if",3,4],["add",2]],
    [["if",7,8],["add",4]],
    [["if",8,9],["add",5]],
    ...
    [["if",8,25],["add",19]],
    [["if",8,26],["add",20]],
    [["if",8,27],["add",21,53,63,64,125,135]],
    [["if",8,28],["add",21,63,64,135]],
    ...
    [["if",8,70],["add",44]],
    [["if",8,71],["add",45]],
    [["if",72],["add",46,47,52,58,61,62,141]],
    [["if",8,52,73],["add",48]],
    [["if",43,74,75],["add",49]],
    [["if",76],["add",50]],
    ...
    [["if",106],["add",72]],
    [["if",0,108],["add",137]],
    [["if",109,110,111],["add",138,140]],
    [["if",0,112,113],["unless",109],["add",139]],
    [["if",0,114],["add",143]],
    [["if",0],["unless",115],["add",144]],
    [["if",5,6],["block",3]],
    [["if",6,107],["block",134,135,136,141]]]
},
"runtime":[]
...
function Vc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Xc={},I=null,Yc=Math.random();Xc.s="GTM-W7MBMN";Xc.yb="2j0";var Zc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},ad="www.googletagmanager.com/gtm.js";var bd=ad,cd=null,dd=null,ed=null,fd="//www.googletagmanager.com/a?id="+Xc.s+"&cv=342",gd={},hd={},id=function(){var a=I.sequence||0;I.sequence=a+1;return a};var jd={},P=function(a,b){jd[a]=jd[a]||[];jd[a][b]=!0},kd=function(a){for(var b=[],c=jd[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(Rj){var e=!1;G(function(){e||Tj(a,b,c)()});return Sj(function(f){e=!0;for(var h={Na:0};h.Na<f.length;h={Na:h.Na},h.Na++)G(function(k){return function(){return a(f[k.Na])}}(h))},b,c)}return D.setInterval(Tj(a,b,c),1E3)},Vj=function(a){Rj?0<=a&&a<Qj.length&&Qj[a]&&(Qj[a].disconnect(),Qj[a]=void 0):D.clearInterval(a)};
var Wj=function(a,b,c){function d(){var h=a();f+=e?(Ga()-e)*h.playbackRate/1E3:0;e=Ga()}var e=0,f=0;return{Kb:function(h,k,l){var m=a(),n=m.de,q=void 0!==l?Math.round(l):void 0!==k?Math.round(m.de*k):Math.round(m.Sf),u=void 0!==k?Math.round(100*k):0>=n?0:Math.round(q/n*100),p=E.hidden?!1:.5<=Oj(c);d();var t=qj(c,"gtm.video",[b]);t["gtm.videoProvider"]="youtube";t["gtm.videoStatus"]=h;t["gtm.videoUrl"]=m.url;t["gtm.videoTitle"]=m.title;t["gtm.videoDuration"]=Math.round(n);t["gtm.videoCurrentTime"]=
Math.round(q);t["gtm.videoElapsedTime"]=Math.round(f);t["gtm.videoPercent"]=u;t["gtm.videoVisible"]=p;fj(t)},Wg:function(){e=Ga()},yc:function(){d()}}};var Xj=D.clearTimeout,Yj=D.setTimeout,V=function(a,b,c){if(Wd()){b&&G(b)}else return lc(a,b,c)},Zj=function(){return D.location.href},ak=function(a){return $e(af(a),"fragment")},bk=function(a){return Ze(af(a))},W=function(a,b){return Md(a,b||2)},ck=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=fj(a)):d=fj(a);return d},dk=function(a,b){D[a]=b},X=function(a,b,c){b&&(void 0===D[a]||c&&!D[a])&&(D[a]=
...
Z.a.vis=["google"],function(){var a={};(function(b){Z.__vis=b;Z.__vis.b="vis";Z.__vis.g=!0;Z.__vis.priorityOverride=0})(function(b){var c,d=[];d.push("CSS"===b.vtp_selectorType?b.vtp_elementSelector:"#"+b.vtp_elementId);d.push(b.vtp_outputMethod);"BOOLEAN"==b.vtp_outputMethod&&d.push(b.vtp_onScreenRatio);c=d.join("&");var e=a[c],f=Number(new Date);if(e&&250>f-e.time)return e.value;e={time:f,value:null};var h=b.vtp_outputMethod,k=null;if("CSS"==b.vtp_selectorType){var l=zc(b.vtp_elementSelector);l&&
0<l.length&&(k=l[0])}else k=E.getElementById(b.vtp_elementId);if(k)switch(h){case "BOOLEAN":var m=(Number(b.vtp_onScreenRatio)||50)/100;e.value=Oj(k)>=m&&!Pj(k);break;case "PERCENT":e.value=0,Pj(k)||(e.value=Math.round(1E3*Oj(k))/10)}a[c]=e;return e.value})}();
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var B=[],z=x.split(","),A=0;A<z.length;A++){var F=Number(z[A]);if(isNaN(F))return[];n.test(z[A])||B.push(F)}return B}function c(){var x=0,B=0;return function(){var z=Nj(),A=z.height;x=Math.max(v.scrollLeft+z.width,x);B=Math.max(v.scrollTop+A,B);return{Uf:x,Vf:B}}}function d(){p=X("self");
t=p.document;v=t.scrollingElement||t.body&&t.body.parentNode;y=c()}function e(x,B,z,A){var F=l(B),J={},M;for(M in F){J.za=M;if(F.hasOwnProperty(J.za)){var U=Number(J.za);x<U||(ck({event:"gtm.scrollDepth","gtm.scrollThreshold":U,"gtm.scrollUnits":z.toLowerCase(),"gtm.scrollDirection":A,"gtm.triggers":F[J.za].join(",")}),tj("sdl",B,function(fa){return function(T){delete T[fa.za];return T}}(J),{}))}J={za:J.za}}}function f(){var x=y(),B=x.Uf,z=x.Vf,A=B/v.scrollWidth*100,F=z/v.scrollHeight*100;e(B,"horiz.pix",
q.wb,u.xd);e(A,"horiz.pct",q.vb,u.xd);e(z,"vert.pix",q.wb,u.Td);e(F,"vert.pct",q.vb,u.Td);sj("sdl","pending",!1)}function h(){var x=250,B=!1;t.scrollingElement&&t.documentElement&&p.addEventListener&&(x=50,B=!0);var z=0,A=!1,F=function(){A?z=Yj(F,x):(z=0,f(),gk("sdl")&&!a()&&(rc(p,"scroll",J),rc(p,"resize",J),sj("sdl","init",!1)));A=!1},J=function(){B&&y();z?A=!0:(z=Yj(F,x),sj("sdl","pending",!0))};return J}function k(x,B,z){if(B){var A=b(String(x));tj("sdl",z,function(F){for(var J=0;J<A.length;J++){var M=
String(A[J]);F.hasOwnProperty(M)||(F[M]=[]);F[M].push(B)}return F},{})}}function l(x){return uj("sdl",x,{})}function m(x){G(x.vtp_gtmOnSuccess);var B=x.vtp_uniqueTriggerId,z=x.vtp_horizontalThresholdsPixels,A=x.vtp_horizontalThresholdsPercent,F=x.vtp_verticalThresholdUnits,J=x.vtp_verticalThresholdsPixels,M=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case q.wb:k(z,B,"horiz.pix");break;case q.vb:k(A,B,"horiz.pct")}switch(F){case q.wb:k(J,B,"vert.pix");break;case q.vb:k(M,
B,"vert.pct")}gk("sdl")?uj("sdl","pending")||(w||(d(),w=!0),G(function(){return f()})):(d(),w=!0,v&&(hk("sdl"),sj("sdl","pending",!0),G(function(){f();if(a()){var U=h();pc(p,"scroll",U);pc(p,"resize",U)}else sj("sdl","init",!1)})))}var n=/^\s*$/,q={vb:"PERCENT",wb:"PIXELS"},u={Td:"vertical",xd:"horizontal"},p,t,v,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):Ni(function(){m(x)})})}();
...
case p.UNSTARTED:return z(O);default:return M}}function U(){for(;B;){var O=x;Xj(B);O()}y.Kf&&ea.Kb("complete",1);return z(p.UNSTARTED)}function fa(){}function T(){B&&(Xj(B),B=0,x=fa)}function da(){if(N.length&&0!==pa){var O=-1,K;do{K=N[0];if(K.wa>w.getDuration())return;O=(K.wa-w.getCurrentTime())/pa;if(0>O&&(N.shift(),0===N.length))return}while(0>O);x=function(){B=0;x=fa;0<N.length&&N[0].wa===K.wa&&(N.shift(),ea.Kb("progress",K.ze,K.Ce));da()};B=Yj(x,1E3*O)}}var ea,N=[],L,Q,S,pa,ma,ua,ab=z(p.UNSTARTED);
...
w.map(function(F){return{wa:F,Ce:F,ze:void 0}});if(!y.length)return B;var z=y.map(function(F){return{wa:F*x,Ce:void 0,ze:F}});if(!B.length)return z;var A=B.concat(z);A.sort(function(F,J){return F.wa-J.wa});return A}function n(w){w.vtp_triggerStartOption?q(w):Ae(function(){q(w)})}function q(w){var y=!!w.vtp_captureStart,x=!!w.vtp_captureComplete,B=!!w.vtp_capturePause,z=k(w.vtp_progressThresholdsPercent+""),A=l(w.vtp_progressThresholdsTimeInSeconds+""),F=!!w.vtp_fixMissingApi;if(y||x||B||z.length||
A.length){var J={Mf:y,Kf:x,Lf:B,Lg:z,Mg:A,je:F,fd:void 0===w.vtp_uniqueTriggerId?"":w.vtp_uniqueTriggerId},M=X("YT"),U=function(){f(J)};G(w.vtp_gtmOnSuccess);if(M)M.ready&&M.ready(U);else{var fa=X("onYouTubeIframeAPIReady");dk("onYouTubeIframeAPIReady",function(){fa&&fa();U()});G(function(){for(var T=X("document"),da=T.getElementsByTagName("script"),ea=da.length,N=0;N<ea;N++){var L=da[N].getAttribute("src");if(b(L,"iframe_api")||b(L,"player_api"))return}for(var Q=T.getElementsByTagName("iframe"),
